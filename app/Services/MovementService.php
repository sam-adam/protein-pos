...
class MovementService
{
    ...
    public function createMovement(Branch $toBranch, array $items, Branch $fromBranch = null, $remark = null, $effectiveAt = null)
    {
        ...
        $movement->movement_effective_at = $effectiveAt ? Carbon::createFromFormat('Y-m-d', $effectiveAt)->setTime(Carbon::now()->hour, Carbon::now()->minute, Carbon::now()->second) : Carbon::now();
        $movement->saveOrFail();
