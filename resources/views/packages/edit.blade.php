        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form method="post" action="{{ route('packages.update', $package->id) }}" class="form-horizontal">
                        {{ csrf_field() }}
                        {{ method_field('PUT') }}
                        <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                            <label for="name" class="col-sm-2 control-label">Name</label>
                            <div class="col-sm-5">
                                <input type="text" id="name" name="name" class="form-control" placeholder="Eg: John Doe" required value="{{ old('name') ?: $package->name }}" />
                        ...
                        <div class="form-group {{ $errors->has('code') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-5">
                                <input type="text" id="code" name="code" class="form-control" placeholder="Eg: pack-cps" required value="{{ old('code') ?: $package->code}}" />
                        ...
                        <div class="form-group {{ $errors->has('cost') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-5">
                                <input type="text" id="price" name="price" class="form-control" placeholder="Eg: 1200" required value="{{ old('price') ?: $package->price }}" />
                        ...
                        <div class="checkbox col-sm-offset-2 {{ $errors->has('is_customizable') ? 'has-error' : '' }}">
                            <label>
                                <input type="checkbox" name="is_customizable" value="1" @if(old('is_customizable') === null ? $package->is_customizable : old('is_customizable')) checked @endif> Is Customizable
                                ...
                                <table class="table table-condensed table-middle table-bordered">
                                    ...
                                    <tbody>
                                        <tr v-for="item in items">
                                            ...
                                            <td style="width: 20px;">
                                                <input type="text" value="0" v-bind:name="'products[' + item.id + '][quantity]'" class="form-control" v-bind:value="item.quantity" />
                                            </td>
                                            <td>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <a href="{{ URL::previous() === route('packages.edit', $package->id) ? route('packages.index') : URL::previous() }}" class="btn btn-danger btn-block">Cancel</a>
                            </div>
                        </div>
                    </form>
                </div>
