                ...
                <div class="panel-body">
                    <form method="post" action="{{ route('branches.store') }}" class="form-horizontal">
                        ...
                        <div class="form-group {{ $errors->has('address') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-5">
                                <textarea id="address" name="address" class="form-control" placeholder="Eg: Baker Street">{{ old('address') }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('contact_person_name') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-5">
                                <input type="text" id="contact_person_name" name="contact_person_name" class="form-control" placeholder="Eg: John Doe" value="{{ old('contact_person_name') }}" />
                        ...
                        <div class="form-group {{ $errors->has('contact_person_phone') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-5">
                                <input type="text" id="contact_person_phone" name="contact_person_phone" class="form-control" placeholder="Eg: 123123123" value="{{ old('contact_person_phone') }}" />
                        ...
                        <div class="form-group {{ $errors->has('cash_counters_count') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-1">
                                <input type="number" id="cash_counters_count" name="cash_counters_count" class="form-control" placeholder="Eg: 2" value="{{ old('cash_counters_count') ?: 1 }}" />
